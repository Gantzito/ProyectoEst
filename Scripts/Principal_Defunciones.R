...
table(data$mes_fall)  #Como en este caso sabes que no existen datos aberrantes respecto al mes_fall usamos el dataframe data
...
table(estcivil$est_civil) #en este caso sabemos que existen datos aberrantes asi que usaremos el dataframe estcivil
barplot(table(estcivil$est_civil))
barplot(table(estcivil$est_civil), xlab="SEXO", main = "SEXO VS NUM. FALLECIDOS", col=c("lightblue","Pink") )
